...
public sealed class Outline
{
    ...
    {
        Outline outlineRet = t.Type == OutlineType.Circle
            ? new Outline(t.position, t.Radius * n)
            : t.Type == OutlineType.Rectangle ? new Outline(t.min * n, t.max * n, t.position, t.Rotation) : null;
        return outlineRet;
    }
